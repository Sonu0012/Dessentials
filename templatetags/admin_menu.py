    ...
    def render(self, context, menus=None):
        ...
        if len(menus) <= 0:
            ...
            if(request.path == reverse('admin:index')):
                r = '<li class="nav-item"><a href="' + reverse('admin:index') + '" class="nav-link active" ><i class="nav-icon fas fa-tachometer-alt"></i> <p>Apna Kaam</p></a></li>'
            else:
                r = '<li class="nav-item"><a href="' + reverse('admin:index') + '" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i> <p>Apna Kaam</p></a></li>'
    ...
    def admin_apps(self, context, r):
        ...
        for app in context['available_apps']:
            if(str(app['app_url']) in request.path):
                    r += '<li class="nav-item has-treeview menu-open"><a href="#" class="nav-link active" style="color:white;"><i class="nav-icon fas fa-edit"></i> <p>%s</p><p><i class="fas fa-angle-left right"></i></p></a><ul class="nav nav-treeview">\n' % (app['name'])
            else:
